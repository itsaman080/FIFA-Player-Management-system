...
$row1 = mysqli_query($con,"SELECT * FROM other_details");
?>
<!DOCTYPE html>
<html>
<head>
...
$('#example1').Tabledit({
    ...
    columns: {
        ...
        editable: [[1, 'club'], [2, 'preferred_position']]
    },
    onDraw: function() {
        console.log('onDraw()');
    },
...
<body>
 ...
 <div class="panel panel-default">       
        ...
        <table cellpadding="0" cellspacing="0" border="0" id="example1">
            <tr><th>Id</th><th>Club</th><th>Preferred Postion</th></tr>
    	<?php while($row = mysqli_fetch_assoc($row1)) {?>
    	<tr>
    		<td><?php echo $row['player_id'];?></td>
    		<td><?php echo $row['club']; ?></td>
    		<td><?php echo $row['preferred_position']; ?></td>
    	<?php } ?>
        </table>
        </div>
    </div>
